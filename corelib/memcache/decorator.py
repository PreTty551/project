...
#
#
# # from python-libmemcached, split_mc.h
# _MC_CHUNK_SIZE = 1000000 - 1000
#
#
...
#
#
# def cache(key_pattern, mc, expire=None, max_retry=0):
#     def deco(f):
...
#
#
# def pcache(key_pattern, mc, count=300, expire=None, max_retry=0):
#     def deco(f):
#         arg_names, varargs, varkw, defaults = inspect.getargspec(f)
#         if varargs or varkw:
#             raise Exception("do not support varargs")
...
#
#
# def pcache2(key_pattern, mc, count=300, expire=None):
#     def deco(f):
#         arg_names, varargs, varkw, defaults = inspect.getargspec(f)
#         if varargs or varkw:
#             raise Exception("do not support varargs")
...
#
#
# def listcache(key_pattern, mc, expire=None, fmt='I'):
...
#
#
# def cache_in_obj(key, mc, expire=None):
#     def deco(f):
#         @wraps(f)
#         def _(obj, *a, **kw):
